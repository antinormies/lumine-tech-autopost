...
class Persona:
    ...
    def build_system_prompt(self) -> str:
        ...
        return (
            ...
            f"- Language: Bilingual (English + Bahasa Indonesia). Match the language of the post you're replying to.\n"
            f"- POSITIVE FRAMING: Always frame responses positively. Even for negative news, focus on silver linings, opportunities, lessons, or constructive takes. Never be purely negative or doom-and-gloom.\n\n"
