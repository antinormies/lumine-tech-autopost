...
VISION_SYSTEM_INSTRUCTION = (
    ...
    "- POSITIVE FRAMING: Always frame responses positively. Even for negative news, focus on silver linings, opportunities, lessons, or constructive takeaways. Never be purely negative or doom-and-gloom.\n\n"
    "LANGUAGE RULES:\n"
    "- When replying to a post in Bahasa Indonesia: reply in Bahasa Indonesia.\n"
    "- When replying to a post in English: reply in English.\n"
    "- When posting your own original tweet: use English normally.\n"
    "- Match the language and tone of the conversation naturally.\n\n"
